...
OUT = ROOT / 'post_p7_language_report_card_v3d_seed8391'
SEED = 8391
...
is excluded from the primary 192. Sixteen query-only prior controls contain no factual
context and are balanced 8/8 between reference candidates; they are diagnostic only.
Sixteen naturalistic prompts are generation-only.

...
audit.OUT=OUT
audit.CK=OUT/'checkpoints/nonsource_localization_suppression/seed_8380/latest.pt'
audit.RET=SRC/'treatment13_retention_quartet_pool.json'
audit.OUTJSON=OUT/'FINAL_FROZEN_RETENTION_RESULTS.json'
audit.main()

"""SF20: identity-heldout balanced entity rotation with SF13 objective.
...
def main():
    ...
    if a.mode == 'preload':
        print('SF20_PRE_PARENT_LOAD_PASS', a.seed, flush=True); return
    ...
    if completed == 0:
        ...
        # Parent-specific U0 reproduction: each SF20 branch must reproduce its OWN SF8 parent.

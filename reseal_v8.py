...
D=Path(r'C:\DaveLM-CADAVER\fact_supervision_87001_corrected_v8')
...
rec={'status':'FULLY_EXECUTABLE_PRETRAINING_FREEZE_COMPLETE','bundle':'fact_supervision_87001_corrected_v8','immutable_predecessor':'fact_supervision_87001_corrected_v7','scientific_specification_changed':False,'mechanical_change':'Added uniquely recoverable binding-reference index, imported torch.nn.functional as F, and moved reconstructed English tensors to the selected device','manifest_sha256':sha(D/'SHA256SUMS.txt'),'payload_count':len(payload),'checkpoint_loaded':False,'optimizer_created':False,'optimizer_update':False,'behavioral_inference':False,'sacred_access':False,'seed_87002_executed':False,'non_circular_chain':'FREEZE_RECEIPT.sha256 -> FREEZE_RECEIPT.json -> SHA256SUMS.txt -> payload'}

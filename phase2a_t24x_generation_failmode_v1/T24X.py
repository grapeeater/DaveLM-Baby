...
OUT = ROOT / "phase2a_t24x_generation_failmode_v1"
T23 = ROOT / "phase2a_t24_inventory_unlikelihood_lr3p75e5_1k_v1"
...
from T24_RUNNER import ARCH, CTX, EOS, TOK_PATH, TOK_SHA, load_jsonl, sha256  # noqa: E402
...
def main():
    ...
    for seed in SEEDS:
        run = ROOT / f"phase2a_t24_inventory_unlikelihood_lr3p75e5_1k_v1_run_seed{seed}"

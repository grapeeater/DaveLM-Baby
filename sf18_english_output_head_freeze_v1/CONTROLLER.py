...
def verify(sealed=True):
    if sealed:
        ...
        assert receipt['status'] == 'SF18_PROSPECTIVE_PREFLIGHT_PASS'
...
def main():
    ...
    if a.mode == 'preload':
        print('SF18_PRE_PARENT_LOAD_PASS', a.seed, flush=True); return
    ...
    rt.atomic_json(scope_audit_sf18(m), out / 'PARAMETER_SCOPE.json')
    ...
    for u in schedule[completed:]:
        ...
        set_scope_sf18(m, u['kind'] == 'binding')

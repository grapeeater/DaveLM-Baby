...
def main():
 assert R.classify([row(True),row(True),row(False,d3=False,status='STOP_REGRESSION')])=='PARTIAL_FIRST_TOKEN_CE_SUPPORTED'
 assert R.classify([row(d3=False,status='STOP_REGRESSION'),row(d3=False,status='STOP_REGRESSION'),row()])=='PARTIAL_FIRST_TOKEN_CE_INSUFFICIENT'

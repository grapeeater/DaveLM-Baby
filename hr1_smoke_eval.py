...
CK=ROOT/'human_readiness_hr1_seed87004_v8/run/checkpoint_500.pt'; TOK=Tokenizer.from_file(r'C:\\DaveLM-v0.9\\tokenizer\\v0_7\\davelm_tokenizer.json')
...
def main():
 ...
 out={'checkpoint_sha256':'pending','prompts':rows,'binding':bind,'sealed_final_accessed':False}; (ROOT/'human_readiness_hr1_seed87004_v8/run/SMOKE_EVAL.json').write_text(json.dumps(out,indent=2,ensure_ascii=False)); print(json.dumps(out,indent=2,ensure_ascii=False))
main()

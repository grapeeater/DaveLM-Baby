...
REPORTER.py and REPORTER_SMOKE_TEST.py are included in the sealed manifest and are never
...
def main():
    ...
    C.rt.atomic_json({'status': 'SF10_PROSPECTIVE_PREFLIGHT_PASS', 'created_utc': datetime.now(timezone.utc).isoformat(),

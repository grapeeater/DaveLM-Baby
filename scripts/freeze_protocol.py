...
FILES = [
    ...
    ROOT / "data_specs" / "V010_FOUNDATION_PROTOCOL_V1R2.json",
    ...
    ROOT / "data" / "generated" / "foundation_v1r2" / "panels.json",
    ROOT / "data" / "generated" / "foundation_v1r2" / "AUDIT_RECHECK.json",
    ROOT / "data" / "generated" / "foundation_v1r2" / "MANIFEST.json",
]

...
def main() -> None:
    files = [
        ...
        "data_specs/V010_FOUNDATION_PROTOCOL_V2R2.json",
        "design/V010_ARCHITECTURE.md",
        "design/V010_CURRICULUM_V2R2.md",
    ...
    out = ROOT / "data_specs" / "V010_FOUNDATION_V2R2_FREEZE.json"
